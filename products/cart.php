        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col text-right">
                    ...
                    <h6 class="full_price mt-3"><?php echo "Total Price in USD: " . $totalPrice; ?></h6>
                    <form method="POST" action="cart.php">
                        <input class="inp_price form-control" type="hidden" value="<?php echo $totalPrice; ?>" name="inp_price">
                        <?php if (count($allProducts) > 0) : ?>
...
<script>
    $(document).ready(function() {
        ...
        $(".pro_qty").on('input', function() {
            ...
            if (isNaN(pro_qty) || pro_qty <= 0) {
                pro_qty = 1;
                $el.find(".pro_qty").val(pro_qty);
            }
